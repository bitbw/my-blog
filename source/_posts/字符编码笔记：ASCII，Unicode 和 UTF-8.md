...
[![bg2007102801.jpg](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2007102801-thumb.jpg)](http://www.ruanyifeng.com/blog/2007/10/bg2007102801.jpg)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121103.jpg)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121115.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121104.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121116.png)

UTF-32的优点在于，转换规则简单直观，查找效率高。缺点在于浪费空间，同样内容的英语文本，它会比ASCII编码大四倍。这个缺点很致命，导致实际上没有人使用这种编码方法，HTML 5标准就明文规定，网页不得编码成UTF-32。

![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121105.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121106.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121117.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121107.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121118.png)

## 五、JavaScript使用哪一种编码？

![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121108.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121109.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121119.jpg)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121120.png)

## 八、JavaScript字符函数的局限

**由于JavaScript只能处理UCS-2编码，造成所有字符在这门语言中都是2个字节，如果是4个字节的字符，会当作两个双字节的字符处理。**JavaScript的字符函数都受到这一点的影响，无法返回正确结果。

![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121110.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121122.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121111.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121112.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121123.png)
...
![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121124.png)

**（5）Unicode正规化**

有些字符除了字母以外，还有[附加符号](http://zh.wikipedia.org/wiki/附加符号)。比如，汉语拼音的Ǒ，字母上面的声调就是附加符号。对于许多欧洲语言来说，声调符号是非常重要的。

![img](C:\E盘资料\my-blog\my-blog\source\_posts\字符编码笔记：ASCII，Unicode 和 UTF-8\bg2014121113.png)
